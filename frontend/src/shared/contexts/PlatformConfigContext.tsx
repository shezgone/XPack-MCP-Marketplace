...
export const _DefaultPlatformConfig: PlatformConfig = {
  name: "POSCO Forged AI",
  logo: "/static/logo/logo.png",
  currency: "USD",
  language: "en",
  website_title: "POSCO Forged AI",
  headline: "POSCO Forged AI",
  subheadline: "Private AI marketplace for industrial MCP services and internal automation.",
  theme: Theme.DEFAULT,
  domain: "",
  is_showcased: false,
  mcp_server_prefix: "posco-forged-ai",
  x_title: "POSCO Forged AI",
  x_description: "Private AI marketplace for industrial MCP services and internal automation.",
  x_image_url: "",
  facebook_title: "POSCO Forged AI",
  facebook_description: "Private AI marketplace for industrial MCP services and internal automation.",
  facebook_image_url: "",
  meta_description: "POSCO Forged AI is a private marketplace for industrial MCP services, internal AI tools, and secure enterprise automation.",
};
