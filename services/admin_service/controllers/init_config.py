...
def get_config(
    ...
    try:
        ...
        config_data = {
            ...
            "platform": {
                "name": values.get(KEY_PLATFORM_NAME, "POSCO Forged AI"),
                "logo": values.get(KEY_PLATFORM_LOGO, ""),
                "url": values.get(KEY_PLATFORM_URL, ""),
                ...
                "domain": values.get(KEY_DOMAIN, ""),
                "is_showcased": values.get(KEY_IS_SHOWCASED, "false").lower() in ("true", "t", "yes", "y", "1"),
